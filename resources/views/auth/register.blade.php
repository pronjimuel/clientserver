    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="opacity : 83%;">
                ...
                <div class="card-header">{{ __('Register a Store') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="storename" type="text" class="form-control @error('storename') is-invalid @enderror" name="storename" value="{{ old('storename') }}" required autocomplete="storename" autofocus>
